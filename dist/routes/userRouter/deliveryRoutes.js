...
router.put("/estimate", authMiddleware_1.default, (0, permissionMiddleware_1.authorizeAnyPermission)(["plan", "sale"]), deliveryController_1.handlePutDelivery);
//=================================DELIVERY REQUEST=====================================
router.get("/planning", authMiddleware_1.default, deliveryController_1.getPlanningRequest);
router.post("/planning", authMiddleware_1.default, (0, permissionMiddleware_1.authorizeAnyPermission)(["plan"]), deliveryController_1.handlePostDeliveryRequest);
router.put("/planning", authMiddleware_1.default, (0, permissionMiddleware_1.authorizeAnyPermission)(["plan"]), deliveryController_1.implementDeliveryPlan);
//=================================SCHEDULE DELIVERY=====================================
router.get("/schedule", authMiddleware_1.default, deliveryController_1.getAllScheduleDelivery);
router.get("/schedule/get-search", authMiddleware_1.default, deliveryController_1.getDeliveryItemsByOrderId);
...
router.put("/prepare", authMiddleware_1.default, (0, permissionMiddleware_1.authorizeAnyPermission)(["delivery"]), deliveryController_1.handleUpdatePreparedGoods);
//socket
