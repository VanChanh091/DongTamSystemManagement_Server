...
exports.default = adminAssociations;
function adminAssociations(models) {
    const { Suppliers, PaperTypes, PaperBasisWeights, SupplierPaperCodes, PaperClassifications } = models;
...
//# sourceMappingURL=admin.association.js.map