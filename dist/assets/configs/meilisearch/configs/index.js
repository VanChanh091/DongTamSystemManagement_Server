...
const setupMeilisearch = async () => {
    await Promise.all([
        ...
        meilisearch_connect_1.meiliClient.index("scrapReports").updateSettings(meilisearch_config_1.scrapReportSettings),
        ...
        meilisearch_connect_1.meiliClient.index("deliveryRequest").updateSettings(meilisearch_config_1.deliveryRequestSettings),
