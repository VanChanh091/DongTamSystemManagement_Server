...
exports.mappingDbPlanningRow = exports.dbPlanningColumns = void 0;
const orderHelpers_1 = require("../helper/modelHelper/orderHelpers");
exports.dbPlanningColumns = [
    //================================PAPER====================================
    // Order
...
const mappingDbPlanningRow = (item, index) => {
    ...
    const stageRows = item.stages.map((stage, sIndex) => ({
...
//# sourceMappingURL=dbPlanningRowAndColumn.js.map