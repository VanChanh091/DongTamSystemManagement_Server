...
import {
  mapReportPaperRow,
  reportPaperColumns,
} from "../../../utils/mapping/reportPaperRowAndColumn";
...
export const getReportedPaperByField = async (req: Request, res: Response) => {
  ...
  const fieldMap = {
    customerName: (report: ReportPlanningPaper) => report?.Planning?.Order?.Customer?.customerName,
...
export const getReportedBoxByField = async (req: Request, res: Response) => {
  ...
  const fieldMap = {
    customerName: (report: ReportPlanningBox) => report?.PlanningBox?.Order?.Customer?.customerName,
